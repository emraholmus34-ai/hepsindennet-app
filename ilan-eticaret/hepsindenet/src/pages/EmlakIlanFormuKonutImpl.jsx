    ...
    <div className="max-w-sm mx-auto bg-gradient-to-b from-black to-black rounded-3xl p-2 shadow-2xl">
      <div className="bg-gray-100 rounded-xl p-4 min-h-[660px] max-h-[680px] overflow-y-auto">
        ...
        <div className="flex items-center mb-6">
          ...
          <div>
            <div className="text-lg font-extrabold text-gray-700">
              <span className="text-gray-700">Konut</span>
        ...
        <div className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <div className={`text-xs mt-1 ${formData.description.length >= 15 ? 'text-green-600' : 'text-red-500'}`}>
                  {formData.description.length}/2000 karakter (en az 15 karakter gerekli)
                </div>
              </div>
                  ...
                  onClick={() => {
                    ...
                    setTimeout(() => {
                      ...
                      setTimeout(() => {
                        ...
                        alert('GPS konumunuz alındı ve form dolduruldu!');
                      }, 100);
                    }, 100);
                  }}
                  ...
                  <div className="bg-white rounded-lg p-4 max-w-md w-full mx-4">
                    ...
                    <div className="bg-gray-100 h-64 rounded-lg flex items-center justify-center mb-4">
                      <div className="text-center">
                        <div className="text-gray-600 mb-4">Harita burada yüklenecek</div>
                    ...
                    <div className="flex gap-2">
                      <button
                        onClick={() => {
                          ...
                          handleInputChange('city', randomLocation.city);
                          setTimeout(() => {
                            handleInputChange('district', randomLocation.district);
                            setTimeout(() => {
                              handleInputChange('neighborhood', randomLocation.neighborhood);
              ...
              <div className="mt-3">
                <label className="flex items-center">
                  <input
                    ...
                    onChange={(e) => handleInputChange('isInSite', e.target.checked)}
                    className="mr-2 rounded border-gray-300 text-blue-600"
                  />
                  <span className="text-sm text-gray-700">Site içerisinde</span>
                </label>
                
                {formData.isInSite && (
                  <div className="mt-2 ml-6">
                    <label className="block text-xs font-medium text-gray-700 mb-1">
                      Site adını yazmak ister misiniz?
                    </label>
                    <input
                      type="text"
                      value={formData.siteName}
                      onChange={(e) => handleInputChange('siteName', e.target.value)}
                      placeholder="Örn: Anadolu Residence"
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm outline-none focus:border-blue-500"
                    />
                  </div>
                )}
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="grid grid-cols-3 gap-3">
                  ...
                  <div>
                    <label className="block text-xs font-medium text-gray-700 mb-1">Brüt m² <span className="text-red-500">*</span></label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="block text-xs font-medium text-gray-700 mb-1">Açık Alan m²</label>
                    <input
                      type="text"
              ...
              <div>
                ...
                <div className="mb-3">
                  <label className="block text-xs font-medium text-gray-700 mb-1">Oda Sayısı <span className="text-red-500">*</span></label>
                  <select
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <label className="block text-xs font-medium text-gray-700 mb-1">Mutfak Tipi</label>
                    <select
                  ...
                  <div>
                    <label className="block text-xs font-medium text-gray-700 mb-1">Balkon</label>
                    <select
                      value={formData.balconyType}
                      onChange={(e) => handleInputChange('balconyType', e.target.value)}
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm outline-none focus:border-blue-500"
                    >
                      <option value="">Seçin</option>
                      <option value="Balkon Yok">Balkon Yok</option>
                      <option value="1 Balkon">1 Balkon</option>
                      <option value="2 Balkon">2 Balkon</option>
                      <option value="3 Balkon">3 Balkon</option>
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      <label className="block text-xs font-medium text-gray-700 mb-1">Kat Sayısı <span className="text-red-500">*</span></label>
                      <select
                    ...
                    <div>
                      <label className="block text-xs font-medium text-gray-700 mb-1">Bulunduğu Kat <span className="text-red-500">*</span></label>
                      <select
                      ...
                      >
                        ...
                        <option value="Çatı Dubleks">Çatı Dubleks</option>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      <label className="block text-xs font-medium text-gray-700 mb-1">Bina Yaşı <span className="text-red-500">*</span></label>
                      <select
                    ...
                    <div>
                      <label className="block text-xs font-medium text-gray-700 mb-1">Isıtma <span className="text-red-500">*</span></label>
                      <select
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-3 mb-3">
                  <div>
                    <label className="block text-xs font-medium text-gray-700 mb-1">Tapu Durumu <span className="text-red-500">*</span></label>
                    <select
                      value={formData.deed}
                  ...
                  <div>
                    <label className="block text-xs font-medium text-gray-700 mb-1">Kullanım Durumu <span className="text-red-500">*</span></label>
                    <select
                    ...
                    >
                      ...
                      <option value="Mülk Sahibi">Mülk Sahibi Oturuyor</option>
                    </select>
                  </div>
                </div>
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <label className="block text-xs font-medium text-gray-700 mb-1">Zemin Etüdü</label>
                    <select
                      value={formData.groundSurvey}
                      onChange={(e) => handleInputChange('groundSurvey', e.target.value)}
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm outline-none focus:border-blue-500"
                    >
                      <option value="">Seçin</option>
            ...
            <div className="space-y-3">
                ...
                {formData.expandedSections.location && (
                  <div className="border-t border-gray-200 p-3">
                    <div className="grid grid-cols-2 gap-2">
                      {['Kuzey Cephe', 'Güney Cephe', 'Doğu Cephe', 'Batı Cephe', 'Deniz Manzara', 'Şehir Manzara', 'Doğa Manzara', 'Cadde Manzara'].map(feature => (
              ...
              <div className="border border-gray-200 rounded-lg">
                <button
                  ...
                  className="w-full flex items-center justify-between p-3 text-left hover:bg-gray-50"
                >
                  <span className="text-sm font-medium text-gray-700">🚗 Otopark ve Ulaşım</span>
                  <span className="text-gray-400">
                ...
                {formData.expandedSections.transport && (
                  <div className="border-t border-gray-200 p-3">
                    <div className="grid grid-cols-2 gap-2">
                      {['Açık Otopark', 'Kapalı Otopark', 'Garaj', 'Asansör', 'Metro', 'Metrobüs', 'Otobüs Durağı', 'Taksi Durağı'].map(feature => (
                        <label key={feature} className="flex items-center text-sm">
                          <input
                            type="checkbox"
              ...
              <div className="border border-gray-200 rounded-lg">
                ...
                {formData.expandedSections.security && (
                  <div className="border-t border-gray-200 p-3">
                    <div className="grid grid-cols-2 gap-2">
                      {['24 Saat Güvenlik', 'Güvenlik Kamerası', 'Kapıcı', 'Diafon', 'Kapalı Devre TV', 'Alarm Sistemi', 'Jeneratör', 'Yangın Merdiveni'].map(feature => (
                        <label key={feature} className="flex items-center text-sm">
                          <input
                            type="checkbox"
              ...
              <div className="border border-gray-200 rounded-lg">
                ...
                {formData.expandedSections.interior && (
                  <div className="border-t border-gray-200 p-3">
                    <div className="grid grid-cols-2 gap-2">
                      {['Parke Zemin', 'Laminat Zemin', 'Seramik Zemin', 'Mermer Zemin', 'Şömine', 'Klima', 'Spot Işık', 'Ankastre Mutfak', 'Buzdolabı', 'Bulaşık Makinesi', 'Fırın', 'Davlumbaz'].map(feature => (
                        <label key={feature} className="flex items-center text-sm">
                          <input
                            type="checkbox"
              ...
              <div className="border border-gray-200 rounded-lg">
                ...
                {formData.expandedSections.technology && (
                  <div className="border-t border-gray-200 p-3">
                    <div className="grid grid-cols-2 gap-2">
                      {['Fiber İnternet', 'WiFi', 'Uydu TV', 'Kablo TV', 'Akıllı Ev', 'Akıllı Kilit', 'Smart TV', 'Ses Sistemi', 'Interkom'].map(feature => (
                        <label key={feature} className="flex items-center text-sm">
                          <input
                            type="checkbox"
              ...
              <div className="border border-gray-200 rounded-lg">
                <button
                  ...
                  className="w-full flex items-center justify-between p-3 text-left hover:bg-gray-50"
                >
                  <span className="text-sm font-medium text-gray-700">🌳 Dış Özellikler</span>
                  <span className="text-gray-400">
                    {formData.expandedSections.outdoor ? '▲' : '▼'}
                  </span>
                </button>
                {formData.expandedSections.outdoor && (
                  <div className="border-t border-gray-200 p-3">
                    <div className="grid grid-cols-2 gap-2">
                      {['Yüzme Havuzu', 'Kapalı Havuz', 'Çocuk Havuzu', 'Sauna', 'Türk Hamamı', 'Fitness', 'Spor Salonu', 'Çocuk Oyun Alanı', 'Barbekü', 'Kamelyalı', 'Pergola'].map(feature => (
                        <label key={feature} className="flex items-center text-sm">
                          <input
                            type="checkbox"
                            checked={formData.outdoorFeatures.includes(feature)}
                            onChange={() => toggleFeature('outdoorFeatures', feature)}
                            className="mr-2 rounded border-gray-300 text-blue-600"
                          />
                          <span className="text-gray-700">{feature}</span>
                        </label>
          ...
          {/* 5. İletişim Seçenekleri */}
          <div className="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
            <h3 className="text-base font-semibold text-gray-800 mb-4 flex items-center">
              <span className="w-6 h-6 bg-indigo-500 text-white rounded-full flex items-center justify-center text-xs font-bold mr-2">5</span>
          ...
          <div className="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
            <h3 className="text-base font-semibold text-gray-800 mb-4 flex items-center">
              <span className="w-6 h-6 bg-orange-500 text-white rounded-full flex items-center justify-center text-xs font-bold mr-2">6</span>
              Fotoğraf ve Video
            </h3>
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-3 gap-2">
                ...
                <div 
                  ...
                  className="border-2 border-dashed border-gray-300 rounded-lg p-3 text-center hover:border-green-400 hover:bg-green-50 transition-colors cursor-pointer"
                >
                  <div className="flex flex-col items-center">
                ...
                <div 
                  onClick={() => alert('Video yükleme özelliği aktiv edildi!')}
                  className="border-2 border-dashed border-gray-300 rounded-lg p-3 text-center hover:border-red-400 hover:bg-red-50 transition-colors cursor-pointer"
                >
                  <div className="flex flex-col items-center">
              ...
              <div className="bg-gray-50 p-3 rounded-lg">
                <div className="text-xs text-gray-600">
                  ...
                  <div>• Fotoğraflar: JPG, PNG formatında, en fazla 10MB</div>
                  <div>• Video: MP4 formatında, en fazla 90 saniye</div>
                  <div>• İlk fotoğraf kapak resmi olarak kullanılır</div>
                </div>
              </div>
            </div>
          </div>
